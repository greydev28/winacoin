...
function LeafTradeIcon({ size = 20, strokeWidth = 1.8, className = '' }) {
  const thickLineWeight = strokeWidth * 0.8;

  return (
    <svg xmlns="http://w3.org" width={size} height={size} viewBox="0 0 256 256" xmlSpace="preserve" className={className}>
      <g style={{ stroke: 'none', strokeWidth: 0, fill: 'none', fillRule: 'nonzero', opacity: 1 }} transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
        <path 
...
const icons = {
  ...
  leafpay: LeafTradeIcon,filecode: FileCheck,
