...
function FooterLink({ href, children, icon }) { return <a href={href} className="mb-3 flex items-center gap-2 text-xs text-zinc-500 transition hover:text-fuchsia-300">{icon && <Icon name={icon} size={14} />}{children}</a> }
